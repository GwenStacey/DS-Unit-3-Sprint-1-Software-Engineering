...
- What, in your opinion, is an important part of code reviews? That is, what is
  ...
  One of the biggest things I look for are obvious errors. As programmers, we
  often let these slip by, so I like to point any out when I see them. Another
  huge factor in code reviews for me is commneting. Commenting falls through
  the cracks for everyone, so it's something I like to point out. Other than 
  those, I look for general readability and pep8 compliance.

- We have an awful lot of computers here, and it gets pretty confusing with
  slightly different things running on all of them. How could containers help us
  improve this situation?

  Containers improve this situation by insuring our app runs in the same environment
  every single time. No matter who runs it where, the docker container loads up the
  same runtime we used when programming it. They also help with scaling, containers
  allow new instances of the web app to be spun up for more customers. Because the
  app works the same way every single time, the customers typically don't notice.
  Docker can also help us with version control, allowing multiple people to collaborate.
